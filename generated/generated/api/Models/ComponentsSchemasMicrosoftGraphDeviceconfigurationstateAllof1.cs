namespace Sample.API.Models
{
    ...
    public partial class ComponentsSchemasMicrosoftGraphDeviceconfigurationstateAllof1 : Sample.API.Models.IComponentsSchemasMicrosoftGraphDeviceconfigurationstateAllof1
    {
        ...
        private Sample.API.Models.IMicrosoftGraphDeviceConfigurationSettingState[] _settingStates;
        ...
        /// <summary>
        /// Creates an new <see cref="ComponentsSchemasMicrosoftGraphDeviceconfigurationstateAllof1" /> instance.
        /// </summary>
    ...
    public partial interface IComponentsSchemasMicrosoftGraphDeviceconfigurationstateAllof1 : Sample.API.Runtime.IJsonSerializable {
        string DisplayName { get; set; }
        string PlatformType { get; set; }
        int? SettingCount { get; set; }
        Sample.API.Models.IMicrosoftGraphDeviceConfigurationSettingState[] SettingStates { get; set; }
