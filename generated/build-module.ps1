...
$dll = Join-Path $PSScriptRoot 'bin\PartialGraphAPI.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\PartialGraphAPI.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './PartialGraphAPI.psd1'
Set-Psd1Export -ExportsFolder $exportsFolder -Psd1Path $psd1

$formatPs1xml = Join-Path $PSScriptRoot './PartialGraphAPI.format.ps1xml'
